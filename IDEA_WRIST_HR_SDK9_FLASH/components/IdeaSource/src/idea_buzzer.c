...
#define ADVERTISING_BUZZER_PIN_NO         IDEA_LED_4//NRF6310_LED_6     /**< Pin that can be used by applications to indicate advertising state.*/
...
static void gpiote_init(void)
{
    ...
    nrf_gpiote_task_configure(GPIOTE_CHAN_FOR_BUZZER_TASK,
