...
#ifdef DEBUG_PHILL
        DEBUG_PRINT("batt_lvl_in_milli_volts:[%d]\n",batt_lvl_in_milli_volts);
#endif
...
#endif
#ifdef DEBUG_PHILL
            DEBUG_PRINT("batt_lvl_in_milli_volts avg:[%d]\n",batt_lvl_in_milli_volts);
#endif
            batt_lvl_in_milli_volts -= get_battery_voltage_adjustment();
#ifdef DEBUG_PHILL
            DEBUG_PRINT("batt_lvl_in_milli_volts after adjustment:[%d]\n",batt_lvl_in_milli_volts);
#endif
        }else{
...
uint8_t voltage_detect_n_precharging(void)
{
    ...
    do {
        DEBUG_PRINT("g_battery_voltage_mv:%d\n",g_battery_voltage_mv);
