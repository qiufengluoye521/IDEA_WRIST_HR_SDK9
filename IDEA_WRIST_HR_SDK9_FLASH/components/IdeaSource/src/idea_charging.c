...
#ifdef DEBUG_LOG
    DEBUG_PRINT("global_device_charging_state: [%d]\r\n",global_device_charging_state);
#endif
...
void function_charger_event_handler(uint8_t pin_no,uint8_t button_action)
{
#ifdef DEBUG_LOG
    DEBUG_PRINT("pin_no: [%d]\r\n",pin_no);
#endif
...
void function_chargingcomplete_event_handler(uint8_t pin_no,uint8_t button_action)
{
#ifdef DEBUG_LOG
    DEBUG_PRINT("pin_no: [%d]\r\n",pin_no);
#endif
...
////                    GPIO_PIN_CNF_SENSE_Low);
    nrf_gpio_cfg_sense_input(CHARGER_CONNECTED_PIN,GPIO_PIN_CNF_PULL_Disabled,NRF_GPIO_PIN_SENSE_LOW);
#endif
#ifdef CHARGER_CHARGING_PIN
...
////                    GPIO_PIN_CNF_DRIVE_S0S1,
////                    GPIO_PIN_CNF_SENSE_Low);
    nrf_gpio_cfg_sense_input(CHARGER_CHARGING_PIN,GPIO_PIN_CNF_PULL_Disabled,NRF_GPIO_PIN_SENSE_LOW);
#endif
}
