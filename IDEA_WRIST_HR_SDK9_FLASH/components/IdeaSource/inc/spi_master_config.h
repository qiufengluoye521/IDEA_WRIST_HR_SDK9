...
#ifdef SPI1
/*  SPI1 */
#define SPI_PSELSCK1              4   /*!< GPIO pin number for SPI clock              */
#define SPI_PSELMOSI1             3   /*!< GPIO pin number for Master Out Slave In    */
#define SPI_PSELMISO1             7   /*!< GPIO pin number for Master In Slave Out    */
#define SPI_PSELSS1               5   /*!< GPIO pin number for Slave Select           */
#endif
#define DEBUG
#ifdef DEBUG
