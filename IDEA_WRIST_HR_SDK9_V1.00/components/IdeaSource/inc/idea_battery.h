...
#ifndef _IDEA_BATTERY_H__
#define _IDEA_BATTERY_H__
...
#define ADC_PRE_SCALING_COMPENSATION         10                                       /**< The ADC is configured to use VDD with no prescaling as input. And hence the result of conversion is to be multiplied by 3 to get the actual value of the battery voltage.*/
#define ADC_HW_PRE_SCALING_COMPENSATION      43
