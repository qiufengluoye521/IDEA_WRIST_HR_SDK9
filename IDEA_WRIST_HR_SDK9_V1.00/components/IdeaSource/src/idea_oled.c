...
void OLED_Init(void)
{
 ...
 #else
    nrf_gpio_pin_dir_set(IIC_CLK,NRF_GPIO_PIN_DIR_OUTPUT);
    nrf_gpio_pin_dir_set(IIC_DAT,NRF_GPIO_PIN_DIR_OUTPUT);
    nrf_gpio_pin_set(IIC_CLK);
    nrf_gpio_pin_set(IIC_DAT);
