...
void all_led_flash()
{
//    nrf_gpio_port_clear((nrf_gpio_port_select_t)NRF_GPIO_PORT_SELECT_PORT0, 0xE4);//BAIDU_LED_0, BAIDU_LED_1, BAIDU_LED_2
//    nrf_gpio_port_clear((nrf_gpio_port_select_t)NRF_GPIO_PORT_SELECT_PORT2, 0x04);//BAIDU_LED_3, BAIDU_LED_4
    nrf_gpio_port_clear((nrf_gpio_port_select_t)NRF_GPIO_PORT_SELECT_PORT0, 0xF8);//BAIDU_LED_0, BAIDU_LED_1, BAIDU_LED_2,BAIDU_LED_3, BAIDU_LED_4
    nrf_delay_ms(400);
//    nrf_gpio_port_set((nrf_gpio_port_select_t)NRF_GPIO_PORT_SELECT_PORT0, 0xE4);//BAIDU_LED_0, BAIDU_LED_1, BAIDU_LED_2
//    nrf_gpio_port_set((nrf_gpio_port_select_t)NRF_GPIO_PORT_SELECT_PORT2, 0x04);//BAIDU_LED_3, BAIDU_LED_4
    nrf_gpio_port_set((nrf_gpio_port_select_t)NRF_GPIO_PORT_SELECT_PORT0, 0xF8); //BAIDU_LED_0, BAIDU_LED_1, BAIDU_LED_2,BAIDU_LED_3, BAIDU_LED_4
    nrf_delay_ms(400);
}
