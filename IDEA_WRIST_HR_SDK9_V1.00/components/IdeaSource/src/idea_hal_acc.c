...
static void LIS3DH_GetFifoData(uint8_t * val)
{
    ...
    fss = (fss >> 2) << 2;
#ifdef DEBUG_ACC
    DEBUG_PRINT( "FSS len %d, ovrun:%d", fss, ovrun);
#endif
...
#ifdef DEBUG_ACC
    //DEBUG_PRINT( "index: %d  || fifo len %d \r\n", index, fss);
#endif
...
{
//    DEBUG_PRINT("start spi_master_enable \r\n");
    spi_master_enable(SPI0);
//    DEBUG_PRINT("finish spi_master_enable and start LIS3DH_GetFifoData\r\n");
    LIS3DH_GetFifoData(val);
//    DEBUG_PRINT("finish LIS3DH_GetFifoData and start spi_master_disable\r\n");
    spi_master_disable(SPI0);
//    DEBUG_PRINT("finish spi_master_disable\r\n");
}
